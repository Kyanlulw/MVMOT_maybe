...
python -m torch.distributed.launch --nproc_per_node="$GPUS" --master_port="$PORT" --use_env main.py --meta_arch multiview_motr --dataset_file e2e_mv_mot --epochs 120 --use_uncertainty_loss --use_reid_query --with_box_refine --lr_scheduler cosine --lr_scheduler_interval step --cosine_start_epoch 80 --lr_drop 25 --lr 2e-4 --lr_backbone 2e-5 --pretrained "$PRETRAIN" --output_dir "$OUTPUT_DIR" --batch_size 1 --sample_mode random_interval --sample_interval 2 --sampler_steps 12 24 36 --sampler_lengths 1 1 1 1 --update_query_pos --merger_dropout 0 --dropout 0 --random_drop 0.1 --fp_ratio 0.3 --query_interaction_layer QIM --extra_track_attn --mot_path "$MOT_PATH" --data_txt_path_train /kaggle/working/MVMOT_maybe/datasets/data_path/multiview_wildtrack.train --data_txt_path_val /kaggle/working/MVMOT_maybe/datasets/data_path/multiview_wildtrack.val --wandb --wandb_project multiview_motr --num_cams 4 --reid_temporal_decay_alpha 0.5 
